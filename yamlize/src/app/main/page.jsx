...
const Header = () => (
  <header className="border-b border-gray-200">
      ...
      <nav className="flex items-center space-x-8">
        <a href="#" className="text-gray-600 hover:text-gray-900 flex items-center space-x-2">
          <span className="text-gray-400 ">
            <svg xmlns="http://www.w3.org/2000/svg" height="12px" width="12px" viewBox="0 0 24 24" className="w-5 h-5">
              <path fill="white" stroke="rgb(92, 92, 102)" strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm10 0a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zM4 16a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm10 0a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2z"></path>
            </svg>
          </span>
          <span>Dashboard</span>
        </a>
    ...
    <div className="bg-black text-white py-1 overflow-hidden w-full">
